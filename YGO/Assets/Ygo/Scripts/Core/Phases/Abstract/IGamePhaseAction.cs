...
namespace Ygo.Core.Phases.Abstract
{
    ...
    {
        ActionResult DrawCard(Guid ownerId);
        ...
        ActionResult CheckAttack(Guid targetId, ICardInstance attacker);
        ActionResult DeclareAttack(Guid targetId, ICardInstance attacker, ICardInstance defender);
        ActionResult DeclareDirectAttack(Guid targetId, ICardInstance attacker);
